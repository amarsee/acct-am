...
school_names <- read_csv("N:/ORP_accountability/data/2020_final_accountability_files/names.csv") %>% 
  bind_rows(
    tribble(
      # Schools that weren't active in the last year, but have data
...
act_student <- read_csv("N:/ORP_accountability/data/2020_ACT/ACT_student_post_appeals.csv",
...
write_csv(school_level_act, "N:/ORP_accountability/data/2020_ACT/ACT_school_post_appeals.csv", na = '')
...
write_csv(district_level_act, "N:/ORP_accountability/data/2020_ACT/ACT_district_post_appeals.csv", na = '')
...
write_csv(state_level_act, "N:/ORP_accountability/data/2020_ACT/ACT_state_post_appeals.csv", na = '')
