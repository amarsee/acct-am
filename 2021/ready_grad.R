...
ready_grad_student <- rg %>%
  select(
    student_key:ncrc_work_keys, participate_clg_lvl_pgm, 
    n_cambridge,
    # n_ap:n_de
  ...
  mutate_at(
    .vars = c('student_key', 'cohortyear', 'district_no', 'school_no', 'completion_type', 'sat_math', 'sat_critical_reading',
              'sat_total', 'act_english', 'act_math', 'act_reading', 'act_science', 'act_composite', 
              'industry_cert_earned',
              'asvab', 'ncrc_work_keys', 'participate_clg_lvl_pgm', 
              'n_cambridge', 'n_ap', 'n_ib', 'n_sdc', 'n_ldc', 'n_de'),
    .funs = as.integer
  ) # %>% 
  # mutate(
  #   district_no = if_else(
...
ready_grad_student_level_total <- read_csv('N:/ORP_accountability/projects/2021_ready_graduate/Data/ready_graduate_student_level.csv',
...
write_csv(district_level_ready_grad, "N:/ORP_accountability/projects/2021_ready_graduate/Data/ready_graduate_district.csv", na = '')
# ===================================== School Level =====================================
...
write_csv(school_level_ready_grad, "N:/ORP_accountability/projects/2021_ready_graduate/Data/ready_graduate_school.csv", na = '')
