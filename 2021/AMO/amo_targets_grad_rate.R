...
district_targets <- read_csv("N:/ORP_accountability/data/2019_graduation_rate/district_grad_rate.csv") %>%
  filter(
...
school_targets <- read_csv("N:/ORP_accountability/data/2019_graduation_rate/school_grad_rate.csv") %>%
