...
# ==================== ACT Highest Cohort ====================
district_current <- read_csv("N:/ORP_accountability/data/2020_ACT/ACT_district_post_appeals.csv") %>%
  filter(
...
school_current <- read_csv("N:/ORP_accountability/data/2020_ACT/ACT_school_post_appeals.csv") %>%
  filter(
    subgroup %in% c("All Students", "Black/Hispanic/Native American", "Economically Disadvantaged",
                    "English Learners", "Students with Disabilities")
  ) %>%
...
state_act <- read_csv("N:/ORP_accountability/data/2020_ACT/ACT_state_post_appeals.csv") %>%
  filter(
    subgroup %in% c("All Students", "Black/Hispanic/Native American", "Economically Disadvantaged",
                    "English Learners", "Students with Disabilities")
  ) %>%
