...
act_student <- read_csv("N:/ORP_accountability/data/2019_ACT/ACT_student_post_appeals_AM.csv",
...
write_csv(school_level_act, "N:/ORP_accountability/data/2019_ACT/ACT_school_post_appeals_AM.csv", na = '')
...
write_csv(district_level_act, "N:/ORP_accountability/data/2019_ACT/ACT_district_post_appeals_AM.csv", na = '')
...
write_csv(state_level_act, "N:/ORP_accountability/data/2019_ACT/ACT_state_post_appeals_AM.csv", na = '')
