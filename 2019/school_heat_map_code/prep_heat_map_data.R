...
indicator_score <- read_csv("N:/ORP_accountability/projects/2019_school_accountability/school_grading_grades_aug14.csv") %>% 
...
# write_csv(heat_map_overall_table, "N:/ORP_accountability/projects/Andrew/Accountability/2019/school_heat_map_data/school_report_scores_Aug15.csv")
