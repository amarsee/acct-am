...
#   b.	Closed Dates: 5/31/19 to 8/31/19.
...
write_csv(closed_schools, "N:\\ORP_accountability\\data\\2020_tdoe_provided_files\\closed_schools.csv", na = "")

# ------------------ Alt, CTE, Adult Schools ----------------------------
# 5.    List of CTE schools: 
#   a.    List of CTE schools active during the 2018-19 school year. 
# 6.    List of adult high schools: 
#   a.    List of Adult schools active during the 2018-19 school year.
# 7.    List of Alternative schools: 
#   a.	List of alternative schools active during the 2018-19 school year
...
write_csv(cte_alt_adult_schools, "N:\\ORP_accountability\\data\\2020_tdoe_provided_files\\cte_alt_adult_schools.csv", na = "")
...
write_csv(new_schools, "N:\\ORP_accountability\\data\\2020_tdoe_provided_files\\new_schools.csv", na = "")

# ----------------- Prior Closed Schools -----------------------------------
# 3.	List of closed schools 2019: 
#   a.	schools that were open at any point or all of the 2019-20 school year but closed by Jul 1, 2020. 
# b.	Closed Dates: 12/1/2019 to 7/1/2020
...
write_csv(prior_closed_schools, "N:\\ORP_accountability\\data\\2020_tdoe_provided_files\\prior_closed_schools.csv", na = "")

# ----------------- SPED Schools -----------------------------------
# 4.  SPED schools: List of Special Education schools active during the 2018-19 school year.
...
write_csv(sped_schools, "N:\\ORP_accountability\\data\\2020_tdoe_provided_files\\sped_schools.csv", na = "")
